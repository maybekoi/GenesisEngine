...
class Util {
    ...
    static public function getOgmo(path:String):String {
        #if web
        if (Assets.exists('assets/data/$path.ogmo')) {
            return Assets.getText('assets/data/$path.ogmo');
        }
        #else
        if (sys.FileSystem.exists(Sys.getCwd() + 'assets/data/$path.ogmo')) {
            return sys.io.File.getContent(Sys.getCwd() + 'assets/data/$path.ogmo');
        }
        #end
        
        trace('OGMO project file not found: $path');
        return "";
    }

    static public function getOgmoLevel(path:String):String {
        #if web
        if (Assets.exists('assets/data/levels/$path.json')) {
            return Assets.getText('assets/data/levels/$path.json');
        }
        #else
        if (sys.FileSystem.exists(Sys.getCwd() + 'assets/data/levels/$path.json')) {
            return sys.io.File.getContent(Sys.getCwd() + 'assets/data/levels/$path.json');
        }
        #end
        
        trace('OGMO level file not found: $path');
        return "";
    }
